...
comp.loadScript('COMPONENTES/ANIMACION/JS/ini.js',function(){
	...
	comp.loadScript('COMPONENTES/CARGANDO/JS/ini.js',function(){
			...
			GL_COMPONENTE_CARGANDO.ini();
				...
				comp.loadScript('COMPONENTES/INFORMACION/JS/ini.js',function(){
					comp.loadCSS('COMPONENTES/INFORMACION/CSS/estilos.css',function(){

							GL_COMPONENTE_INFORMACION=new OBJ_INICIALIZA_INFORMACION();
							GL_COMPONENTE_INFORMACION.ini();
					});
				});
