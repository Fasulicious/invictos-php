...
require_once("../COMPONENTES/CONEXION/Conexion.php");
require_once("../DAO/DAOLogin.php");
require_once("../COMPONENTES/UTIL_PHP/verificacion.php");
require_once("../COMPONENTES/UTIL_PHP/variables_globales.php");
